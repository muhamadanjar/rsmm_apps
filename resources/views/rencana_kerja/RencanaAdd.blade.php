...
<?php
	$kode_rencana = $kode;
?>
<form role="form" method="POST" enctype="multipart/form-data" action="{{ url('rencana/kerja') }}">
	<div class="row">
		<div class="col-md-8">
			<div class="box box-default">
				...
				<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="kode_rencana" name="kode_rencana" value="{{ $kode_rencana }}">
							<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input  class="form-control" name="dari_tgl" id="dari_tgl" type="text">
							<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="sampai_tgl" id="sampai_tgl" >
							<div class="col-md-6">
